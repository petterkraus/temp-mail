...
export default function OpenedMail({openedEmail}) {
  return (
    <>
    {!openedEmail && (
        <div className="w-full ml-6 mr-8 px-4 py-4 mt-12 pb-10 h-fill bg-gray-200 rounded-xl max-md:mr-4">
          <p className="text-xs text-gray-500">
            Your Inbox is Ready! <br /> Your e-mails will show up and you just need to click on them once to open here.{" "}
          </p>
        </div>
      )}
